\# PySpectral Quantum Solver (v2.0.0)
...
To maintain a professional environment, the following structure is recommended:



\* `/pyspectral`: Core source code (`PySpectral.py`).

\* `/docs`: Technical manuals and documentation (including the original PDF).

\* `/examples`: Demonstration scripts and Jupyter notebooks.

\* `/output`: Automatically generated folder for saved plots and data tables.
...
\*\*Vagner Jandre Monteiro\*\* \[vagner.jandre@iprj.uerj.br](mailto:vagner.jandre@iprj.uerj.br)
